        ...
        <div className="p-[1rem] sm:p-0 flex flex-col justify-between gap-5">
          ...
          <ul className="mt-6 space-y-5">
            {bullets.map((item) => (
              ...
              >
                <span className="w-2 h-2 mt-2 rounded-full bg-primaryText"></span>
                <div>
                  <h4 className="font-semibold font-[Poppins] text-[12px] sm:text-[14px]">
                    {item.title}
                  </h4>
                  <h4 className="font-[Poppins] text-[16px] sm:text-[16px] leading-relaxed">
                    {item.text}
                  </h4>
                </div>
              </li>
