  ...
  return (
    <section className="container grid grid-cols-1 md:grid-cols-2 bg-white items-end  py-6 sm:py-8 md:py-12 lg:pt-12 lg:pb-20  gap-5 sm:gap-3 md:gap-5 lg:gap-6">
      <div className="">
        ...
        <h4 className="font-['Prata'] text-[#43474E] font-normal text-sm leading-4 md:leading-8  md:text-[18px]  mt-12">
      ...
      <div className="" aria-label="Contact Form">
        ...
        >
          ...
          <div className="pt-2 flex justify-start">
            <button
              className="font-['Prata'] text-white bg-[#1E247E] font-normal rounded-full text-sm md:text-[21px] px-8 py-3 border-none"
              type="submit"
            >
              Download Brochure
            </button>
